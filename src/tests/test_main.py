...
def test_add_molecule():
    response = client.post("/molecule/add",
                           json={"identifier": "mol", "smiles": "Cc1ccccc1"})
    assert response.status_code == 200
    assert response.json() == {"message": "molecule was added"}


def test_get_molecule():
    client.post("/molecule/add",
                json={"identifier": "mol", "smiles": "CCO"})
...
def test_update_molecule():
    client.post("/molecule/add",
                json={"identifier": "mol", "smiles": "Cc1ccccc1"})
    response = client.put("/molecule/mol",
                          json={"identifier": "mol", "smiles": "CCO"})
    assert response.status_code == 200
...
def test_delete_molecule():
    client.post("/molecule/add",
                json={"identifier": "mol", "smiles": "CC(=O)O"})
...
def test_list_molecules():
    client.post("/molecule/add",
                json={"identifier": "mol1", "smiles": "c1ccccc1"})
    client.post("/molecule/add",
                json={"identifier": "mol2", "smiles": "CC(=O)O"})
...
def test_substructure_search():
    client.post("/molecule/add",
                json={"identifier": "mol1", "smiles": "CC(=O)O"})
    client.post("/molecule/add",
                json={"identifier": "mol2", "smiles": "c1ccccc1"})
